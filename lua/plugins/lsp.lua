return {
  ...
  config = function()
    ...
    local servers = {
      ...
      -- Additional LSP servers for broader language support
      gopls = {  -- Go
        settings = {
          gopls = {
            analyses = {
      ...
      rust_analyzer = {  -- Rust
        settings = {
          ['rust-analyzer'] = {
            diagnostics = {
              enable = false,  -- Disable rust-analyzer diagnostics in favor of other tools
            },
          },
        },
      },
    ...
    -- Use mason-lspconfig for LSP servers (handles name mapping)
    require('mason-lspconfig').setup {
      ensure_installed = vim.tbl_keys(servers or {}),
    }
    -- Use mason-tool-installer for additional tools
    require('mason-tool-installer').setup {
      ensure_installed = {
        'stylua', -- Used to format Lua code
        'typescript-language-server', -- Explicitly install TS server
        'prettier', -- Formatter for JS/TS/HTML/CSS/JSON/etc.
